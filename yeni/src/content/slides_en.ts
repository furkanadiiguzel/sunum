...
export const slidesEn: Slide[] = [
  ...
  },
  {
    ...
    body:
      "This is not a cold, rigid automation. It’s a human-like AI concierge that talks to guests in everyday language, understands tone (urgent vs. casual), and adapts to each situation. It can communicate naturally in Albanian, English, and Turkish and any other language you want. When the moment calls for empathy or discretion, it escalates to your team with a tidy summary and recommended next steps. In practice, you’ll see: faster replies, smoother arrivals, clearer housekeeping plans, quicker review responses, and a monthly rhythm of reports and simple, month-by-month marketing actions.",
    visual: {
      type: 'image',
  ...
  },
  {
    ...
    bullets: [
      'Before arrival: simple, fixed-price add-ons like upgrade, late check-out, airport transfer, breakfast.',
      'During the stay: well-timed, friendly reminders (e.g., spa late-afternoon special).',
