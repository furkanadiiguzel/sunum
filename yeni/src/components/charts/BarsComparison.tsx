    ...
    <figure aria-label="Para vs Pas sipas KPI" className="card-surface p-3">
      ...
      <ResponsiveContainer width="100%" height={140}>
        <BarChart data={data} barCategoryGap={10} margin={{ top: 2, right: 6, left: 6, bottom: 0 }}>
          ...
          <Legend />
          <Bar dataKey="Before" name={beforeLabel} fill={ChartTheme.colors.primary} radius={ChartTheme.barRadius} />
          <Bar dataKey="After" name={afterLabel} fill={ChartTheme.colors.accent} radius={ChartTheme.barRadius} />
        </BarChart>
      </ResponsiveContainer>
    </figure>
  )
